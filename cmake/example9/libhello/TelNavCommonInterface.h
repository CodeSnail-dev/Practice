...
#ifndef TELNAVCOMMONINTERFACE_H_
#define TELNAVCOMMONINTERFACE_H_
...
DllExport typedef void (*CallbackFunction)(int *, int *, void *, int);
...
//TMC
DllExport typedef struct _TMC_STATION_ITEM_T  // Renamed from _TMC_STATION_LIST_T 
{
	unsigned char index;
...
DllExport typedef struct _TMC_STATION_LIST_T  // New Added structure, mentioned in c), used to provide a list of _TMC_STATION_ITEM_T
{
...
DllExport typedef struct _TMC_STATION_INFO_T
{
...
DllExport typedef struct _TMC_DATA_T
{
...
//GPS
DllExport typedef struct _GPS_DATA_T
{
     char GPSData[1024]	; //NMEA DATA format
} GPS_DATA_T ;

DllExport typedef struct _ONSTAR_DESTINATION_INFO_T
{
...
//Touch Position
DllExport typedef struct _TOUCH_POSITION_INFO_T
{
...
DllExport typedef struct _TN_TURN_INDICATOR_T
{
...
//Popup
DllExport typedef struct _TN_ICON_ALERT_POPUP_T
{
...
DllExport typedef struct TN_BT_PBLIST_T
{
	int count;
...
//Calibration
DllExport typedef struct _TN_CAL_DATA_LIST_T {
    /*VE_PARAM */
...
DllExport typedef struct _TN_GNSS_DATA
{
...
DllExport typedef struct _TN_MAP_MATCHING_FEEDBACK
{
